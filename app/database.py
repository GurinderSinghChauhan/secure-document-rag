...
class DocumentRecord(Base):
    ...
    classification_status: Mapped[str] = mapped_column(String(24), default="unclassified", server_default=text("'unclassified'"), index=True)
    classification_source: Mapped[str] = mapped_column(String(16), default="automatic", server_default=text("'automatic'"))
